        ...
        <div>
            <form className="space-y-5">
                ...
                <label className="input relative input-bordered outline-none flex items-center gap-2">
                    ...
                    <input type="date" className="grow" placeholder="date of birth" />
                </label>
                <label className='flex hover:underline items-center gap-4'>
                    <input type="checkbox" onChange={(event: React.ChangeEvent<HTMLInputElement> | boolean) => event.target.checked === true ? document.getElementById("submit")?.removeAttribute('disabled') : document.getElementById("submit")?.setAttribute('disabled', '')} />
                    Tarms & Conditions
                </label>
